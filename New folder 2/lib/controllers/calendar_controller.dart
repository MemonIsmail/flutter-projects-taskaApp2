...
import '../screens/widgets/custom_calendar.dart';
...
class CalendarController extends GetxController{
  ...
  void showCalendar({VoidCallback? onPressed}){
    final previousDay = theSelectedDay.value;
    Get.defaultDialog(
      title: '',
      ...
      actions: [
        Row(
          ...
          children: [
            TextButton(
              onPressed: (){
                theSelectedDay.value = previousDay;
                theFocusedDay.value = previousDay;
                Get.back();
              },
              child: Text(
                'Cancel',
