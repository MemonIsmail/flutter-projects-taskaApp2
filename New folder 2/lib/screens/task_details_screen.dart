...
class TaskDetailsScreen extends GetView<TaskDetailsController>{
  ...
  Widget build(BuildContext context) {
    ...
    final TaskDetailsModel task = Get.arguments;

    controller.title.value = task.title;
    ...
    controller.description.value = task.description;
                ...
                children: [
                  GestureDetector(
                    ...
                    TaskSection(
                      ...
                      title: 'Status', detail: controller.selectedStatus.value,
                      iconColor: (controller.selectedStatus.value == 'Completed') ? kPrimaryColor
                        : (controller.selectedStatus.value == 'Pending') ? kYellowColor
                        : kGreenColor
                    ),
                  ),
                  ...
                  GestureDetector(
                    ...
                    TaskSection(
                      icon: Icons.flag,
                      title: 'Priority',
                      detail: controller.selectedPriority.value,
                      iconColor: (controller.selectedPriority.value == 'High') ? kRedColor
                        : (controller.selectedPriority.value == 'Low') ? kYellowColor
                        : kGreenColor
                    ),
                  ),
                              ...
                              child: Column(
                                children: [
                                  ...
                                  CustomDropDownMenu(
                                    ...
                                    hintText: 'Select',
                                    onSelected: (value) => controller.selectedAssignee.value = value ?? controller.selectedAssignee.value,
                                  ),
                                ],
                              ),
                            );
