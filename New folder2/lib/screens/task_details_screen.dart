                ...
                children: [
                  GestureDetector(
                    ...
                    TaskSection(
                      ...
                      iconColor: (controller.selectedStatus.value == 'Completed') ? kPrimaryColor
                        : (controller.selectedStatus.value == 'In Progress') ? kGreenColor
                        : kYellowColor,
                    ),
                  ),
                  ...
                  GestureDetector(
                    ...
                    TaskSection(
                      ...
                      iconColor: (controller.selectedPriority.value == 'High') ? kRedColor
                        : (controller.selectedPriority.value == 'Normal') ? kGreenColor
                        : kYellowColor
                    ),
                  ),
                  ...
                  GestureDetector(
                    ...
                    child: TaskSection(
                      icon: Icons.person,
                      title: 'Assignee',
                      detail: controller.selectedAssignee.value,
                  ...
                  GestureDetector(
                    ...
                    child: TaskSection(
                      ...
                      title: 'Due Date',
                      detail: controller.selectedDate.value.isNotEmpty
