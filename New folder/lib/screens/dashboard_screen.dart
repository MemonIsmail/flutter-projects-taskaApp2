...
class DashboardScreen extends GetView<DashboardScreenController>{
                                  ...
                                  children: [
                                    Expanded(
                                      child: CustomButton(
                                        ...
                                        onPressed: (){
                                          Get.back();
                                          taskScreenController.fetchTasksByEmail();
                                          taskScreenController.isSelected.value = 'All';
                                          FocusScope.of(context).unfocus();
                                        }
                                      ),
                                    ),
                                    ...
                                    Expanded(
                                      child: CustomButton(
                                        ...
                                        onPressed: (){
                                          Get.back();
                                          if(taskScreenController.isSelected.value == 'All'){
                                            taskScreenController.fetchTasksByEmail();
                                          }
                                          else{
                                            taskScreenController.fetchTasksByEmailAndStatus();
                                          }
                                          FocusScope.of(context).unfocus();
                                        },
                                      ),
  ...
  Widget _status(String title){
    return GestureDetector(
      onTap: () => taskScreenController.onStatusSelected(title),
      child: Obx((){
        final bool isSelected = taskScreenController.isSelected.value == title;
        return Container(
          decoration: BoxDecoration(
