  ...
  Future<sqflite.Database> open(
    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        ...
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `TaskEntity` (`title` TEXT NOT NULL, `priority` TEXT NOT NULL, `status` TEXT NOT NULL, `assignee` TEXT NOT NULL, `description` TEXT NOT NULL, PRIMARY KEY (`title`))');
