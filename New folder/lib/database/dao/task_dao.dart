...
abstract class TaskDao {
  ...
  @Query('UPDATE TaskEntity SET status = :status, priority = :priority, assignee = :assignee WHERE id = :id')
  Future<void> updateTask(int id, String status, String priority, String assignee);
